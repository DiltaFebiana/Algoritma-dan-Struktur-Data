            ...
            switch (pilih){
                case 1:
                        ...
                        System.out.println("NIM\t\t\tNama\t\t\tTelp");
                            for (Mahasiswa mhs:am) { 
                                ...
                                System.out.println(mk.kode+"\t\t"+mk.matakuliah+"\t\t\t"+mk.sks+"\t\t\t");
                                }
                                System.out.print("Pilih MK by kode: ");
                                String kode = sc1.nextLine();
                ...
                case 2:
                        ...
                        System.out.println("NIM\t\tNama\t\tMata Kuliah\t\t\tSKS\tNilai");
                            for (Nilai ni: an) {
                                System.out.println(ni.mahasiswa.nim+"\t"+ ni.mahasiswa.nama+"\t\t"+ ni.mk.matakuliah+"\t\t"+ ni.mk.sks+"\t"+ ni.nilai);
                                }
                            break;
                case 3:
                        System.out.println("DAFTAR NILAI MAHASISWA");
                        ...
                        System.out.println("NIM\t\tNama\t\tMata Kuliah\t\t\tSKS\tNilai");
                            ...
                            nilaiNim.mahasiswa.nama+"\t\t"+ nilaiNim.mk.matakuliah+"\t\t"+ nilaiNim.mk.sks+"\t\t"+ nilaiNim.nilai);
                            }
                        }
